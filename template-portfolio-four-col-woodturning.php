<?php
/*
Template Name: Portfolio, Four Columns, Woodturning
*/
?><?php get_header(); ?>
	<?php global $pinboard_page_template; ?>
	<?php $pinboard_page_template = 'template-portfolio-four-col.php'; ?>
	...
	<div id="container">
		<section id="content" class="column onecol">
			...
			<?php $args = array( 
						'category_name' => 'woodturning',
						//'cat' => pinboard_get_option( 'portfolio_cat' ), 
